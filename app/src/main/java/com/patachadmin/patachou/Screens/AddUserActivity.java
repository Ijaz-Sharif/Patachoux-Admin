        ...
        storageReference.putFile(imgUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        myRef=  FirebaseDatabase.getInstance().getReference("User").child(getUserId(AddUserActivity.this)).child(id);
                        myRef.child("Name").setValue(et_user_name.getText().toString());
                        myRef.child("UserId").setValue(id);
                        myRef.child("AdminId").setValue(getUserId(AddUserActivity.this));
                        ...
                        if(et_code.getText().toString().isEmpty()){
                            myRef.child("SecretCode").setValue("not available");
                        }
                        else {
