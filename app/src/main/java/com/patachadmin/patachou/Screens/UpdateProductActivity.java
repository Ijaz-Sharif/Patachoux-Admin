              ...
              storageReference.putFile(imgUri)
                      .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                          ...
                          public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                              ...
                              if (getIntent().getStringExtra("type").equals("Bread")) {
                                  myRef = FirebaseDatabase.getInstance().getReference("Products").child("Bread").child(productId);
                              } else {
                                  myRef = FirebaseDatabase.getInstance().getReference("Products").child("Pastry").child(productId);
                              }
                      ...
                      .addOnFailureListener(new OnFailureListener() {
                          ...
                          public void onFailure(@NonNull Exception e) {
                              ...
                              Toast.makeText(UpdateProductActivity
