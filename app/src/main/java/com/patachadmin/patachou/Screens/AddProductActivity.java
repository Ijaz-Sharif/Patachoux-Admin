...
import static com.patachadmin.patachou.Utils.Constant.createOrderId;
...
public class AddProductActivity extends AppCompatActivity {
    EditText product_name,product_des;
    ...
    public void saveProduct(View view) {
        ...
        if(product_name.getText().toString().trim().isEmpty()){
            ...
            Toast.makeText(AddProductActivity.this,"image is required",Toast.LENGTH_LONG).show();
        }
                        ...
                        .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                if (getIntent().getStringExtra("type").equals("Bread")) {
                                    myRef = FirebaseDatabase.getInstance().getReference("Products").child("Bread").child(id);
                                } else {
                                    myRef = FirebaseDatabase.getInstance().getReference("Products").child("Pastry").child(id);
                                }
                                myRef.child("ProductId").setValue(id);
