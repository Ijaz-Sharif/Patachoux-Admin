...
public class UserPasteryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_user_pastery, container, false);
    ...
    public void getProductsData(){
        ...
        dRef=  FirebaseDatabase.getInstance().getReference("User").child(getUserId(getContext())).child(USERID).child("Products").child("Pastry");
